<template>
    <TransitionRoot as="template" :show="open">
        <Dialog as="div" class="relative z-50">
                                ...
                                <div class="flex flex-col gap-3">
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                        ...
                                        <div class="flex flex-col gap-1">
                                            ...
                                            <DxDateBox v-model:value="prenotazione.data_inizio" :min="now" type="datetime"
                                                :is-valid="!errorFor('data_inizio')" label="Data e ora della visita"
                                            ...
                                            <DxSelectBox v-model:value="prenotazione.medico_id" :search-enabled="true"
                                                ...
                                                :drop-down-options="{ maxHeight: '200px' }"
                                                :item-template="medicoItemTemplate" :is-valid="!errorFor('medico_id')" />
                                            ...
                                            <div class="flex items-center gap-3">
                                                <DxButton id="saveButton" width="100%" text="Nuova società" icon="plus"
                                                    type="normal" styling-mode="contained" :disabled="false"
                                                    @click="apriModalNuovaSocieta" />
                                                <DxButton id="saveButton" width="100%" height="100%" text="Apri società"
                                                    icon="activefolder" type="normal" styling-mode="contained"
                                            ...
                                            <DxSelectBox v-model:value="prenotazione.societa_id"
                                                ...
                                                display-expr="ragione_sociale" :search-enabled="true" :search-timeout="500"
                                                label="Società sportiva" label-mode="static"
                                                no-data-text="Nessuna società trovata" :disabled="disabledElement"
                                                :drop-down-options="{ maxHeight: '200px' }"
                                                :on-selection-changed="selezionaSocieta" :is-valid="!errorFor('societa_id')"
                                                :open-on-field-click="false" :min-search-length="2" />

                                            <DxNumberBox v-model:value="prenotazione.numero_paz" placeholder="1"
                                                :show-spin-buttons="true" :is-valid="!errorFor('numero_paz')"
                                                label="Numero di atleti" :disabled="disabledElement" />
                                            ...
                                            <DxSelectBox v-model:value="prenotazione.visita.sport_id"
                                                ...
                                                :item-template="sportItemTemplate" :is-valid="!errorFor('visita.sport_id')"
                                                :disabled="disabledElement" no-data-text="Nessuno sport trovato" />                                            

                                            <DxSelectBox v-model:value="prenotazione.visita.listino_id"
                                                :search-enabled="true" label="Listino Agonistico"
                                                :data-source="listiniAgonisticiFiltratiPerSport" value-expr="id"
                                                display-expr="nome" :item-template="listinoItemTemplate"
                                                :is-valid="!errorFor('visita.listino_id')" :disabled="disabledElement"
                                                no-data-text="Nessun listino trovato" />

                                            <DxSelectBox v-model:value="prenotazione.visita.listino_id"
                                                :search-enabled="true" label="Listino non Agonistico"
                                                :data-source="listini_non_agonistici" value-expr="id" display-expr="nome"
            ...
            <ModalSocietaSportiva v-if="modal_societa_id" :societa-id="modal_societa_id" @close="modal_societa_id = null"
                @store="societaSalvata" @update="societaModificata" />
        </Dialog>
</TransitionRoot>
</template>
...
import ModalSocietaSportiva from '../Anagrafiche/ModalSocietaSportiva.vue';
