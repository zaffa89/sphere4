...
class ValidatePrenotazioneRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'ambulatorio_id' => 'exclude_if:nascosta,true,required',
            'medico_id' => 'nullable',
            'note' => 'nullable|max:255',
            'durata' => 'exclude_if:nascosta,true|required|integer|min:1',
    ...
    public function messages() {
        return [
            'visita.paziente_id.required_if' => "Non hai selezionato il paziente",
            ...
            'ambulatorio_id.required' => 'Non hai selezionato un AMBULATORIO',
